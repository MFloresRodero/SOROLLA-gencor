...
# csv_file = "/home/maria/git/SOROLLA/SumStats/paired_datasets.csv"
...
#     out_file = f"/home/maria/git/SOROLLA/Results/ldsc/{row['condition_1']}_{row['dataset_name_1']}_{row['condition_2']}_{row['dataset_name_2']}"
