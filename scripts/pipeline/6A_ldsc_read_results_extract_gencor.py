    ...
    with open(file_path, 'r') as file:
        ...
        for i, line in enumerate(lines):
            ...
            if "Summary of Genetic Correlation Results" in line:
                ...
                result['id_1'] = os.path.basename(file_path).split("_")[0]
                result['label_1'] = os.path.basename(file_path).split("_")[1]
                result['id_2'] = os.path.basename(file_path).split("_")[2]
                result['label_2'] = os.path.basename(file_path).split("_")[3].split(".")[0]
                result['rg'] = values[2]
                result['se'] = values[3]
                result['z'] = values[4]
                result['p'] = values[5]
